...
mannyBurns = Appointment.create(date:"2017-2-13 19:56:56", doctor_id:1, patient_id:1)

mannyStorm = Appointment.create(date:"2017-6-08 19:56:56", doctor_id:1, patient_id:5)
